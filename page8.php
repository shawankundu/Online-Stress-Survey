...
<body id="home">
                ...
                <form action="form_action.php" method="post" onsubmit="return validateForm()">
                    ...
                    <div class="col-lg-12 col-12" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="question-card col-sm-10 position-relative" style="height: 145px;" role="group">
                            ...
                            <div class="position-absolute gif border">
                                <img src="https://media.tenor.com/1btOD8KWJ2cAAAAC/you-are-criticizing-me-imane-anys.gif" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-12" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="question-card col-sm-10 position-relative" style="height: 145px;" role="group">
                            ...
                            <div class="position-absolute gif border">
                                <img src="https://media.tenor.com/BNjoXFZBmvsAAAAd/bts-bangtan-boys.gif" alt="">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-12 col-12" data-aos="fade-up" data-aos-delay="200">
                        ...
                        <div class="question-card col-sm-10 position-relative" style="height: 145px;" role="group">
                            ...
                            <div class="position-absolute gif border">
                                <img src="https://media.tenor.com/Q1DibKVE944AAAAC/tired-sleepy.gif" alt="">
                            </div>
                        </div>
                    </div>
    ...
    <script>
        function validateForm() {
            var group1RadioButtons = document.getElementsByName('q22');
            var group2RadioButtons = document.getElementsByName('q23');
            var group3RadioButtons = document.getElementsByName('q24');
